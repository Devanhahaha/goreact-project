...
import { useUsersDelete } from "../../../hooks/user/useUsersDelete";
...
export default function UsersIndex() {
    ...
    const { mutate, isPending } = useUsersDelete();
                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                ...
                                {users?.map((user: User, index: number) => (
                                    <tr key={user.id} className="hover:bg-gray-50 transition-colors duration-100">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <button onClick={() => handleDelete(user.id)} disabled={isPending} className="inline-flex items-center gap-1 text-xs font-medium bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 px-3 py-1.5 rounded-md transition-colors duration-150">
