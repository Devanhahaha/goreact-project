...
import { useUsersById } from "../../../hooks/user/useUsersById";
import { useUsersUpdate } from "../../../hooks/user/useUsersUpdate";
...
export default function UserUpdate() {
    ...
    const {mutate, isPending} = useUsersUpdate();

    const HandleUpdateUser = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        mutate({ id: Number(id), data: {name, username, email, password} }, {
    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            <main className="flex-1 p-8">
                ...
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Update User</h1>
                    <p className="text-sm text-gray-500 mt-1">Fill in the details to update a user account</p>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <form onSubmit={HandleUpdateUser} className="px-6 py-6 space-y-5">
